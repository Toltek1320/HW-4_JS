...
console.log(`Сумма элементов массива - ${sum(newArr)}`);
...
console.log(`Минимальное число массива - ${min(newArr)}`);

// 3. Найти есть ли в этом массиве число 3

function presence(number) {
    if (number > 0) {
        return `В массиве присутствует цифра 3 в кол-ве  ${number} шт.`
    } else {
        return `В массиве нет цифры 3`
    }
}
